...
const ILEAD_CAMPAIGNS: Campaign[] = [
    {
        ...
        description: "Providing proactive professional check-ins, direct technical workspace assistance, and collaborative safety nets for engineers breaking out of extreme isolation.",
    ...
    },
    {
        ...
        description: "Breaking down financial planning, scalable team operations, and market positioning for local creators trying to build sustainable businesses.",
    ...
    },
    {
        ...
        category: "Community Giving",
        description: "A zero-interest, crowd-fueled collective pool helping community members purchase modern laptops and essential remote working setups.",
        ...
        <section className="w-full bg-white max-w-7xl mx-auto px-6 md:px-12 py-24">
            ...
            <div className="text-center mb-16 max-w-3xl mx-auto">
                ...
                <p className="text-base sm:text-lg text-purple-950/60 font-medium leading-relaxed">
                    We don't just talk about change; we build it through hands-on interaction, deep strategic mentorship, and unconditional support. Explore our ongoing workflows.
                </p>
            </div>
                    ...
                    >
                        ...
                        <div>
                            <div className="flex justify-between items-center pt-5 border-t border-purple-950/5 mb-6 text-sm">
                                <span className="text-purple-950/50 font-medium">{campaign.metricLabel}</span>
