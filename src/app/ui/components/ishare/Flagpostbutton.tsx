...
// const FLAGS_COLLECTION = "ishare_flags"; // admin bucket
...
//       {open && (
//         <div className="absolute right-0 top-8 w-60 bg-white border border-purple-950/10 rounded-2xl shadow-xl shadow-purple-950/10 p-3 z-30">
//           {done ? (
//             <div className="flex items-center gap-2 px-2 py-3 text-emerald-600">
//               <svg
//                 className="w-4 h-4"
...
//       {open && (
//         <div className="absolute right-0 top-8 w-52 bg-white border border-purple-950/10 rounded-2xl shadow-xl shadow-purple-950/10 p-3 z-30">
//           {done ? (
//             <div className="flex items-center gap-2 px-2 py-3 text-emerald-600">
//               <svg
//                 className="w-4 h-4"
