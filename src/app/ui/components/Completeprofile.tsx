...
import { AppDispatch } from "../../redux/store"; // ← add
...
// // Explicit type for the Firestore updateDoc payload — avoids the
// // "unknown not assignable to FieldValue | Partial<unknown>" TS error
...
//   // the userSlice setUser action is already called by your app entry point listener
//   useEffect(() => {
//     // Give Redux one tick to hydrate from onAuthStateChanged before redirecting
//     const timer = setTimeout(() => {
//       if (!isLoggedIn) {
//         navigate("/join-our-commnity", { replace: true });
//       }
//     }, 300);
...
//     // Build payload with the explicit ProfileUpdate type so TypeScript
//     // is satisfied by Firestore's updateDoc parameter constraint
...
//     try {
//       await updateDoc(doc(db, "users", reduxUser.uid), profileData);
//       // Clean up the temporary sessionStorage entries
//       sessionStorage.removeItem("ilead_account_type");
//       sessionStorage.removeItem("ilead_reg_data");
//       setIsDone(true);
//     } catch (err) {
