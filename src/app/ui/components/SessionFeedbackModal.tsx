...
const SessionFeedbackModal: React.FC<SessionFeedbackModalProps> = ({
  ...
  const [integrityEscalationFlag, setIntegrityEscalationFlag] =
  ...
  const handleNotesChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    const containsViolation = BANNED_KEYWORDS.some((keyword) =>
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    console.log(
      "ITRAIN-012 -> Dispatching core review index registry map:",
      feedbackData,
    );
          ...
          <button
            ...
            className={`text-xl transition-all duration-150 transform hover:scale-125 focus:outline-none cursor-pointer ${
              starIndex <= currentValue
                ...
                : "text-purple-950/10 hover:text-amber-400"
            }`}
          >
            ★
          </button>
        ...
        <div className="mb-6">
          <div className="flex justify-between items-start gap-4">
            <div>
              ...
              <h2
                id="modal-title"
                className="text-xl font-black text-purple-950 tracking-tight mt-3"
              >
          ...
          <p className="text-xs text-purple-950/50 font-medium mt-1.5">
            Your confidential evaluation keeps our academy standards high.
            Reviewing session with{" "}
            <span className="text-purple-950 font-bold">{instructorName}</span>.
          </p>
        </div>
        ...
        <form onSubmit={handleFormSubmit} className="space-y-5">
          ...
          <div className="space-y-4 bg-slate-50 p-4 rounded-2xl border border-purple-950/[0.02]">
            <div>
              ...
              <p className="text-[10px] text-purple-950/40 font-medium -mt-0.5">
                Was the roadmap delivered plainly and easily understood?
              </p>
            ...
            <div>
              ...
              <p className="text-[10px] text-purple-950/40 font-medium -mt-0.5">
                Did they map clear actionable steps, targets, or study metrics?
              </p>
            ...
            <div>
              ...
              <p className="text-[10px] text-purple-950/40 font-medium -mt-0.5">
                Did the consultant demonstrate expert competence in the field?
              </p>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5 px-0.5">
              ...
              <span className="text-[10px] font-medium text-purple-950/30">
                Optional
              </span>
            </div>
            <textarea
            ...
            <div className="p-3.5 bg-rose-50 border border-rose-200 rounded-xl flex items-start gap-3 animate-headShake">
              ...
              <div>
                ...
                <p className="text-[10px] text-rose-800/80 font-medium mt-0.5 leading-relaxed">
                  Your input includes context phrases flagged for security
                  auditing. Upon submission, this review bypasses public
                  indexing and streams immediately to core workspace admins for
                  verification.
                </p>
              </div>
            </div>
