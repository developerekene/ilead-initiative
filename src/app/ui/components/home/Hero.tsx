    ...
    <section className="bg-white-500 w-full min-h-screen flex items-center justify-center pt-18 pb-16 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 w-full flex flex-col items-center text-center relative z-10">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black tracking-tight text-purple-950 leading-[1.12] mb-8 w-full max-w-4xl">
          {firstTitle} <br className="hidden sm:inline" />
          {secondTitle}{" "}
        ...
        <div className="flex flex-col sm:flex-row gap-5 w-full sm:w-auto justify-center items-center">
          {btnOneOnClick ? (
            <button
              ...
              className="w-full sm:w-auto bg-orange-500 hover:bg-purple-700 text-white font-bold px-10 py-4 rounded-xl transition-all duration-300 transform hover:-translate-y-0.5 shadow-lg shadow-orange-500/20 hover:shadow-purple-700/20 cursor-pointer text-base whitespace-nowrap"
            >
              {buttonOneText}
            </button>
          ) : (
          ...
          {btnTwoOnClick ? (
            <button
              ...
              className="w-full sm:w-auto bg-transparent text-purple-950 border-2 border-purple-100 hover:border-purple-950 hover:bg-purple-50/50 font-bold px-10 py-4 rounded-xl transition-all duration-300 cursor-pointer text-base whitespace-nowrap"
            >
              {buttonTwoText}
            </button>
          ) : (
