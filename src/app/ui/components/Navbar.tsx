              ...
              <div className="absolute right-0 mt-3 w-64 rounded-2xl bg-white border border-orange-100 shadow-xl shadow-purple-950/10 overflow-hidden z-50">
                ...
                <div className="px-4 py-4 border-b border-gray-100">
                  {isLoggedIn ? (
                    ...
                    <>
                      <p className="font-bold text-purple-950">Not signed in</p>
...
//             <button
//               onClick={() => setIsProfileOpen(!isProfileOpen)}
//               className="hidden sm:flex items-center justify-center w-11 h-11 rounded-full border border-orange-100 bg-white hover:bg-orange-50 transition-colors shadow-sm cursor-pointer"
//             >
//               <svg
//                 className="w-5 h-5 text-purple-900"
//                 fill="none"
...
//                 {/* User Info */}
//                 <div className="px-4 py-4 border-b border-gray-100">
//                   <p className="font-bold text-purple-950">John Doe</p>
