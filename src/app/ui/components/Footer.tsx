...
const Footer: React.FC = () => {
  ...
  const isJoinCommunityPage = location.pathname === "/join-our-community";
  ...
  return (
    <footer className="w-full bg-white max-w-7xl mx-auto px-6 md:px-12 pt-12 pb-16">
        ...
        <div className="w-full bg-purple-950 px-6 py-16 md:py-20 rounded-[2.5rem] text-center text-white mb-20 relative overflow-hidden shadow-2xl shadow-purple-950/20">
          ...
          <div className="max-w-3xl mx-auto flex flex-col items-center">
            ...
            <p className="text-base sm:text-lg text-purple-100/80 font-medium max-w-2xl leading-relaxed mb-10">
              True leadership isn't about standing alone at the top; it's about
              holding the door open for others. Bring your skills, share your
              journey, and anchor yourself in an ecosystem built on collective
              growth.
            </p>
            <Link to="/join-our-community" className="w-full sm:w-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 pb-12 border-b border-purple-100">
        ...
        <div className="lg:col-span-4 flex flex-col items-start">
          ...
          <p className="text-sm sm:text-base text-purple-950/60 font-medium leading-relaxed max-w-xs mb-6">
            A self-sustaining circle of mentorship where tech expertise,
            business strategy, and unconditional support meet to bridge social
        ...
        <div className="lg:col-span-2 lg:col-start-6 flex flex-col">
          <h4 className="text-purple-950 font-bold text-sm uppercase tracking-wider mb-5">
            Mentorship Hub
          </h4>
      ...
      <div className="pt-8 text-center text-xs sm:text-sm font-medium text-purple-950/40">
        &copy; {new Date().getFullYear()} iLEAD Ecosystem. Grounded in
        selflessness, driven by collaboration, and dedicated to elevating one
        another.
      </div>
    </footer>
  );
