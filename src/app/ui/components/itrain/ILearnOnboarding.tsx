...
const ILearnOnboarding: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!tracks.isLearner && !tracks.isTeacher) {
      setErrors([
        "You must explicitly select at least one option to customize your workspace layout.",
      ]);
    ...
    try {
      ...
      setErrors([
        "An error occurred mapping your database preferences. Please retry.",
      ]);
      setIsSubmitting(false);
    }
  };
      ...
      <div className="bg-white w-full max-w-3xl rounded-[2.5rem] shadow-xl shadow-purple-950/5 border border-purple-950/5 p-8 md:p-12 lg:p-16">
        ...
        <div className="text-center mb-12 max-w-xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-black tracking-tight text-purple-950 mt-4 mb-3">
            Welcome to <span className="text-purple-700">iTrain</span>
          </h2>
          <p className="text-sm sm:text-base text-purple-950/60 font-medium leading-relaxed">
            Customize your workspace layout. Choose how you intend to engage
            with our self-sustaining peer ecosystem today.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
            ...
            <div
              ...
              className={`group relative border rounded-3xl p-6 md:p-8 flex flex-col justify-between cursor-pointer select-none transition-all duration-300 transform hover:-translate-y-1 ${
                tracks.isLearner
            ...
            >
              <div>
                ...
                <h3 className="text-xl font-black mb-2 tracking-tight group-hover:text-orange-500 transition-colors duration-200">
                  I Learn
                </h3>
                <p
                  className={`text-xs sm:text-sm leading-relaxed font-medium ${tracks.isLearner ? "text-purple-200" : "text-purple-950/60"}`}
                >
                  Master actionable study habits, organize your CGPA targets,
                  and work live with industry professionals before university.
                </p>
              </div>
            </div>
            ...
            >
              <div>
                ...
                <p
                  className={`text-xs sm:text-sm leading-relaxed font-medium ${tracks.isTeacher ? "text-purple-200" : "text-purple-950/60"}`}
                >
                  Share your institutional knowledge, help students clear
                  academic blocks, and build the next tier of academic leaders.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-50 border border-purple-950/[0.03] rounded-2xl p-4 text-center text-xs text-purple-950/50 font-medium">
            💡 <strong className="text-purple-950">Pro-tip:</strong> You can
            select{" "}
            <span className="text-purple-900 font-bold">both tracks</span> if
            you plan to share your strengths while developing yourself in other
            disciplines.
          </div>
