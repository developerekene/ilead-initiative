          ...
          {EXPERTISE_OPTIONS.map((filter) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between text-left px-4 py-3 rounded-xl border text-sm font-semibold transition-all duration-200 cursor-pointer ${
                  isChecked
              ...
              >
                ...
                <div className="pt-4 border-t border-purple-950/5 flex items-center justify-between gap-4 mt-auto">
                  <div className="flex flex-col">
                    <span className="text-[10px] font-bold text-purple-950/40 uppercase tracking-wider">
                      Impact Counter
                    </span>
          ...
          <div className="relative w-full max-w-xs bg-white h-full p-6 shadow-2xl flex flex-col justify-between animate-in slide-in-from-right duration-200">
            <div>
              <div className="flex items-center justify-between pb-4 border-b border-purple-950/5 mb-6">
                <h3 className="font-black text-base text-purple-950 tracking-tight">
                  Directory Filters
                </h3>
                <button
                  onClick={() => setIsMobileDrawerOpen(false)}
