  ...
  const historyTimeline = [
    {
      year: "March 2026",
      title: "The Genesis",
      description: "iLead was intentionally founded by Ekene and co-founder Promise with a bold operational mandate: to spread an empowering tech ideology, fight professional isolation, and help individuals live purposeful, unblocked lives using digital tools."
    },
    {
      year: "Spring 2026",
      title: "Ecosystem Expansion",
      description: "Launched targeted community initiatives, including structural mentorship pairing frameworks and peer-backed crowd-funding resources like the Equipment Fund to unlock technical access barriers."
    },
    {
      year: "June 2026",
      title: "Local & Regional Outreaches",
      description: "Initiated deep offline-to-online regional campaigns—deploying clean, informative physical and digital assets across business sectors to bridge local commerce with automated AI systems."
    }
  ];

  // Core Value Pillars
  const valuePillars = [
    { title: "Radical Inclusivity", desc: "Building support frameworks like our Disability Panels and cross-regional mentorship tiers so nobody is locked out of global talent workspaces.", icon: "🌱" },
    { title: "Practical Application", desc: "Rejecting abstract fluff in favor of rigorous, career-focused skill blocks tailored around actual macroeconomic needs.", icon: "⚙️" },
    { title: "Human Validation", desc: "Providing active peer safety nets, direct code reviews, and physical resources to combat developer and creator burnout.", icon: "🤝" }
  ];
  ...
  const leaders = [
    {
      ...
      imageSrc: "https://media.licdn.com/dms/image/v2/D4E03AQHiqi4YHQpQLA/profile-displayphoto-crop_800_800/B4EZywxwZxGYAM-/0/1772492361198?e=1784160000&v=beta&t=xG4teEQN6mBQAZ91E7HKJc92iOZD9XNdCV0caNk4dAI", // Add path to your profile image asset here (e.g., "/images/ekene.jpg")
      linkedInUrl: "https://www.linkedin.com/in/ekenedilichukwu-okoli-7615591b5",
      statement: "True digital empowerment isn't about teaching abstract theories or building for flashy aesthetics. It's about dismantling systemic access blocks. I engineered iLead to function as a highly practical human accelerator—equipping developers and creators with the rugged, real-world engineering architecture required to scale globally and build sustainable operational autonomy."
    },
    {
      ...
      imageSrc: "https://media.licdn.com/dms/image/v2/D4D03AQHoyIkk-1S0vA/profile-displayphoto-crop_800_800/B4DZy92UwRH4AI-/0/1772711663085?e=1784160000&v=beta&t=A01r2VZSixEYaaJ3KMzkE5nTkfv2CL_eBXCONtlLD0k", // Add path to your profile image asset here
      linkedInUrl: "https://www.linkedin.com/in/promise-joshua-980b79363",
      statement: "Community isn't just a collective grouping of people; it is an economic and collaborative engine. My mandate within iLead is to build resilient, hyper-functional connective tissue between emerging talent, cross-regional mentorship tiers, and crucial funding pools like the Equipment Fund. We ensure no brilliant mind remains locked behind infrastructural barriers."
    }
  ];
    ...
    <div className="w-full bg-white text-purple-950 min-h-screen font-sans overflow-x-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-4 lg:pt-14">
            <p className="text-base sm:text-lg text-purple-950/70 font-medium leading-relaxed">
              iLead is a coordinated human engine designed to spread tech ideology and elevate professional vectors. We operate across three distinct tracks: Tech Mentorship, Business Strategy, and Community Giving.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        <div className="lg:col-span-4 space-y-3 lg:sticky lg:top-8">
          <h2 className="text-xs font-black text-purple-950/40 uppercase tracking-widest pl-0.5">Core Philosophy</h2>
          <h3 className="text-2xl sm:text-3xl font-black tracking-tight">The Principles That Fuel Our Blueprint</h3>
          <p className="text-sm text-purple-950/60 font-medium leading-relaxed">
            We do not design futuristic, abstract concepts. We build clean, high-utility frameworks that deliver direct economic and educational solutions.
          </p>
        </div>
        ...
        <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-5 w-full">
          {valuePillars.map((pillar, index) => (
            <div
              key={index}
              className={`bg-slate-50 border border-purple-950/[0.02] p-6 sm:p-8 rounded-2xl space-y-3 hover:bg-white hover:shadow-md transition-all duration-300 ${index === 2 ? "sm:col-span-2" : ""
                }`}
            >
              ...
              <h4 className="text-base font-black tracking-tight text-purple-950">{pillar.title}</h4>
              <p className="text-xs sm:text-sm text-purple-950/70 font-semibold leading-relaxed">{pillar.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-purple-950 text-white rounded-[2.5rem] mx-4 my-8 md:mx-8 px-6 py-16 md:py-24 shadow-xl relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="text-center space-y-2">
            <span className="text-[10px] font-black uppercase tracking-widest text-orange-400">Our Evolution</span>
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight">How iLead Tracks Forward</h2>
          </div>
            ...
            {historyTimeline.map((item, i) => (
              <div key={i} className="relative group">
                ...
                <div className="space-y-1">
                  ...
                  <h4 className="text-lg font-black tracking-tight text-white">{item.title}</h4>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 md:py-24 space-y-16">
        ...
        <div className="text-center space-y-3 max-w-2xl mx-auto">
          ...
          <h3 className="text-3xl font-black tracking-tight text-purple-950 pt-2">Coordinated Management</h3>
          <p className="text-sm text-purple-950/60 font-medium leading-relaxed">
            iLead is systematically anchored by active engineering leaders and strategic partners dedicated to expanding global digital talent infrastructure.
          </p>
        </div>
          ...
          <div className="bg-slate-50/50 border border-purple-950/[0.02] p-8 md:p-10 rounded-[2rem] flex flex-col justify-between space-y-6 hover:bg-white hover:shadow-sm transition-all duration-300">
            <div className="space-y-4">
              ...
              <p className="text-xs sm:text-sm text-purple-950/70 font-semibold leading-relaxed">
                To aggressively lower the barrier to technological excellence by providing localized, high-impact learning frameworks, structured professional mentorship layers, and active funding assets—equipping individuals to overcome workspace roadblocks and live purposeful, unblocked lives.
              </p>
            </div>
          ...
          <div className="bg-purple-950 text-white p-8 md:p-10 rounded-[2rem] flex flex-col justify-between space-y-6 shadow-xl shadow-purple-950/5 relative overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs sm:text-sm text-white/80 font-medium leading-relaxed">
                To anchor a resilient, self-sustaining global talent network where structural inequalities are bypassed through open digital integration—positioning creators, engineers, and local businesses to lead regional technology ecosystems autonomously.
              </p>
            </div>
        ...
        <div className="space-y-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            <div className="lg:col-span-5 space-y-2">
              ...
              <h3 className="text-3xl font-black tracking-tight text-purple-950 pt-2">Multi-Sector Integration</h3>
            </div>
            <div className="lg:col-span-7">
              <p className="text-sm sm:text-base text-purple-950/60 font-medium leading-relaxed">
                iLead does not limit technological progress to code bases. We deploy specialized workflow frameworks across critical local commerce sectors to systematically scale visibility and operations.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
            {[
              { track: "01 / Tech & Systems", label: "Software Architecture", desc: "Rigorous focus on modern mobile development architectures, engineering team leadership templates, typescript validation layers, and automated custom AI business logic workflows." },
              { track: "02 / Scalable Enterprise", label: "Food, Fashion & Retail", desc: "Grounding creative creators, local culinary entrepreneurs, and designers in defensible unit economics, supply operational overhead diagnostics, and brand positioning." },
              { track: "03 / Capital & Workspace", label: "Ecosystem Entrepreneurship", desc: "Bypassing hardware limits via crowd-fueled financing, structuring digital talent mentorship modules, and forming remote team placement pipelines for global impact." }
            ].map((item, i) => (
              <div key={i} className="bg-slate-50 border border-purple-950/[0.02] rounded-2xl p-6 sm:p-8 space-y-4 hover:bg-white hover:shadow-sm transition-all duration-300">
      ...
      <section className="max-w-6xl mx-auto px-6 pb-16 md:pb-24">
        <div className="bg-orange-50/60 border border-orange-200/50 rounded-3xl p-8 md:p-12 text-center space-y-6 relative overflow-hidden">
          ...
          <div className="max-w-2xl mx-auto space-y-3">
            ...
            <p className="text-xs sm:text-sm text-purple-950/70 font-semibold leading-relaxed">
              Whether you want to solve core educational challenges, explore mentorship assets, or back an equipment fund, your place in our community directory awaits.
            </p>
          </div>

          <div className="flex flex-wrap items-center justify-center gap-3">
            <a href="/all-Campaign" type="button" className="bg-purple-950 hover:bg-orange-500 text-white font-black text-xs uppercase tracking-wider px-6 py-3.5 rounded-xl shadow-lg shadow-purple-950/10 hover:shadow-orange-500/10 transition-all cursor-pointer">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-purple-950/60 font-medium leading-relaxed">
              We track operational output dynamically. Our milestones represent real systems distributed, hours invested, and unblocked talent tracks.
            </p>
          </div>

          <div className="lg:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-4 w-full">
            {[
              { value: "850+", unit: "Active Peers Connected", detail: "Breaking isolated engineering blocks" },
              { value: "450+", unit: "Mentorship Hours Gifted", detail: "Senior technical leadership syncs" },
              { value: "84", unit: "Laptops Provided", detail: "Zero-interest hardware assets" },
              { value: "100%", unit: "Community Backed", detail: "No hidden micro-financing tiers" },
              { value: "24/7", unit: "Technical SOS Channel", detail: "Live codebase review instances" },
              { value: "3 Tiers", unit: "Cohort Management", detail: "From basic tracks to high acceleration" }
            ].map((metric, idx) => (
              <div key={idx} className="bg-slate-50/50 border border-purple-950/[0.01] p-5 rounded-2xl space-y-1 hover:bg-white hover:shadow-sm transition-all duration-200">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 md:py-24 border-b border-purple-950/5">
        <div className="space-y-12">
          <div className="text-center space-y-2 max-w-xl mx-auto">
            <span className="text-[10px] font-black uppercase tracking-widest text-purple-950/40">Structured Paths</span>
            <h3 className="text-2xl sm:text-3xl font-black tracking-tight text-purple-950">Cohort Mentorship Architecture</h3>
          </div>
            ...
            {[
              {
                ...
                focus: ["Unblocking core typescript logic", "Git workflow architecture essentials", "Basic UI layout system engineering"]
              },
              {
                tier: "Tier 02",
                name: "Career Acceleration Matrix",
                intent: "Mid-level practitioners targeting senior ownership roles.",
                focus: ["Cross-platform mobile engineering", "Firebase & Data integration hooks", "Remote team management principles"]
              },
              {
                tier: "Tier 03",
                name: "Strategic Founders Sprint",
                intent: "Technical leaders scaling physical & digital businesses.",
                focus: ["Unit economics & pipeline structures", "Custom AI business logic integration", "Service pricing & client contracts"]
              }
            ].map((item, index) => (
              <div key={index} className="border border-purple-950/5 rounded-2xl p-6 sm:p-8 flex flex-col justify-between bg-white hover:border-orange-500/20 shadow-sm hover:shadow-md transition-all duration-300">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-mono font-black text-orange-500 uppercase tracking-wider">{item.tier}</span>
                    <span className="w-1.5 h-1.5 rounded-full bg-purple-950/20" />
                  </div>
                  <h4 className="text-lg font-black tracking-tight text-purple-950 leading-tight">{item.name}</h4>
                  <p className="text-xs text-purple-950/50 font-medium leading-relaxed">{item.intent}</p>

                  <hr className="border-purple-950/5 pt-2" />

                  <ul className="space-y-2.5">
                    {item.focus.map((bullet, bIdx) => (
                      <li key={bIdx} className="flex items-start gap-2 text-xs text-purple-950/70 font-semibold leading-relaxed">
                        <span className="text-orange-500 mt-0.5 shrink-0 select-none">▪</span>
                        <span>{bullet}</span>
                      </li>
                    ))}
                  </ul>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 bg-purple-950 text-white rounded-[2.5rem] p-8 sm:p-12 space-y-6 relative overflow-hidden shadow-xl">
            ...
            <p className="text-xs sm:text-sm text-white/75 font-medium leading-relaxed">
              Technical burnout is a direct byproduct of unvalidated isolation. We construct structured, real-time channels where developers can process roadblocks, share authentic career stress factors, and reclaim mental balance without judgment.
            </p>

            <div className="pt-4 border-t border-white/10 flex flex-wrap gap-4 text-xs font-bold text-white/90">
              <div className="flex items-center gap-1.5">
                <span className="w-1 h-1 rounded-full bg-orange-500" /> Weekly Circles
              </div>
              <div className="flex items-center gap-1.5">
                <span className="w-1 h-1 rounded-full bg-orange-500" /> Safe Architecture Spaces
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 space-y-6 lg:pl-4">
            <div>
              <h4 className="text-xs font-black text-purple-950/40 uppercase tracking-widest pl-0.5">Accountability Parameters</h4>
              <h5 className="text-xl font-black tracking-tight text-purple-950 mt-1">Proactive Human Synchronization</h5>
            </div>

            <div className="space-y-4">
              {[
                { label: "Bi-Weekly Mental Check-Ins", desc: "Coordinated structural meetings mapping developer fatigue indexes and operational anxieties before they trigger workspace failure." },
                { label: "Safe Unfiltered Code Review", desc: "No tech egos allowed. A dedicated, clean sandbox workspace where juniors can present broken or fragmented systems safely." },
                { label: "Direct Workspace Safety Nets", desc: "Emergency technical help channels backed by remote engineering managers to pull talent out of complex blockers immediately." }
              ].map((item, idx) => (
                <div key={idx} className="flex gap-4 items-start bg-slate-50/60 border border-purple-950/[0.01] p-4 rounded-xl">
                  ...
                  <div className="space-y-1">
                    <h6 className="text-xs font-black text-purple-950 tracking-tight uppercase">{item.label}</h6>
                    <p className="text-xs text-purple-950/60 font-semibold leading-relaxed">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 md:py-24">
        <div className="bg-orange-50/40 border border-orange-200/40 rounded-3xl p-8 md:p-12 space-y-8 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="lg:col-span-7">
              <p className="text-xs sm:text-sm text-purple-950/70 font-semibold leading-relaxed">
                We strip out the futuristic tech buzzwords to provide local enterprises and creators with clean, high-utility operational blueprints. Our continuous outreaches deliver physical frameworks, direct workflows, and automated logic setups right to business doorsteps.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4 border-t border-purple-950/5">
            {[
              { title: "Targeted Ingestion Letters", text: "Direct, transparent operational diagnostic materials tailored to physical commercial storefront parameters." },
              { title: "Clean AI Workflows", text: "Deploying automated customer capturing databases and workflow logic built entirely without abstract tech layouts." },
              { title: "No Futuristic Overkill", text: "Pure information architecture structured to lower operational overhead margins immediately and safely." },
              { title: "Direct Account Linkage", text: "Connecting offline merchants seamlessly to verified local tech talent pools within the iLead grid." }
            ].map((block, bIdx) => (
              <div key={bIdx} className="space-y-1.5 bg-white p-5 rounded-xl border border-purple-950/[0.02]">
                <h4 className="text-xs font-black text-purple-950 tracking-tight uppercase flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-orange-500" /> {block.title}
                </h4>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-8">
            <div className="space-y-3">
              ...
              <p className="text-sm text-purple-950/60 font-medium leading-relaxed">
                iLead scales through clear, high-utility alignments. We invite forward-thinking technology firms, educational institutions, regional commerce brands, and individual benefactors to back our talent layers and resource infrastructure.
              </p>
            </div>
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
            ...
            <div className="bg-slate-50/60 border border-purple-950/[0.02] p-6 sm:p-8 rounded-[2rem] space-y-4 hover:bg-white hover:shadow-sm transition-all duration-300">
              ...
              <p className="text-xs sm:text-sm text-purple-950/70 font-semibold leading-relaxed">
                For companies or academic groups aiming to integrate code modules, host physical local business outreaches, deploy remote engineering talent pipelines, or provide direct mentorship resources to our active cohorts.
              </p>
            ...
            <div className="bg-slate-50/60 border border-purple-950/[0.02] p-6 sm:p-8 rounded-[2rem] space-y-4 hover:bg-white hover:shadow-sm transition-all duration-300">
              ...
              <p className="text-xs sm:text-sm text-purple-950/70 font-semibold leading-relaxed">
                For benefactors funding capital requirements—directly provisioning hardware setup to the Equipment Fund, offsetting platform bandwidth allocation fees, or sponsoring micro-grants for outstanding student projects.
              </p>
              <hr className="border-purple-950/5 pt-1" />
              <div className="text-[11px] text-purple-950/40 font-bold">
